...
var i,j,p1,p2,p3,p4,p5,p6,p7,p8,p9:longint;
begin
...
b[8]:=p5+p7+p8+p9+a[8];
b[9]:=p6+p8+p9+a[9];
if (b[1]mod 4=0)and(b[2]mod 4=0)and(b[3]mod 4=0)and(b[4]mod 4=0)and(b[5]mod 4=0)and(b[6]mod 4=0)and(b[7]mod 4=0)and(b[8]mod 4=0)and(b[9]mod 4=0) then
begin
